---
title: "How to Build Your Own Context Provider"
description: "Learn how to create custom context providers for Continue using HTTP servers, CustomContextProvider API, or VSCode extensions to provide tailored context to your AI assistant"
---

## How to Create an HTTP Context Provider
...
<Info>
  ...
  Servers](/customize/deep-dives/mcp), and [Prompts](/customize/deep-dives/prompts)
  where possible.
</Info>

## How to Use CustomContextProvider
...
### How to Create Custom Context Providers with Submenu or Query
...
## How to Use Extension API for VSCode
