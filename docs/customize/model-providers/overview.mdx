...
| [DeepSeek](/customize/model-providers/top-level/deepseek)      | Specialized code models with strong performance                                 | Chat, Edit, Apply                           |
| [Mistral](/customize/model-providers/top-level/mistral)        | High-performance open models with commercial offerings                          | Chat, Edit, Apply, Embeddings               |
| [xAI](/customize/model-providers/top-level/xAI)                | Grok models from xAI                                                            | Chat, Edit, Apply                           |
...
| [OpenRouter](/customize/model-providers/more/openrouter)               | Gateway to multiple model providers                        |
...
| Provider                                                 | Description                                   |
| :------------------------------------------------------- | :-------------------------------------------- |
| [LM Studio](/customize/model-providers/more/lmstudio)    | Desktop app for running models locally        |
