...
description: "Learn how to use blocks in Continue Hub to enhance your AI code assistant."
---

Blocks are used to build custom AI code assistants in Continue Hub. Learn more:
