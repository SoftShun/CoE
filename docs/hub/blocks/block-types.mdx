---
title: "Block Types in Continue Hub: Models, Context Providers, Prompts, and More"
sideBarTitle: "Block Types"
description: "Explore the different types of reusable blocks in Continue Hub including models, context providers, documentation, MCP servers, rules, prompts, and data components"
---
