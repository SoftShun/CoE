...
declare global {
  ...
  export interface Config {
     ...
     * A CustomContextProvider requires you only to define a title and getContextItems function. When you type '@title <query>', AXCode will call \`getContextItems(query)\`.
     */
