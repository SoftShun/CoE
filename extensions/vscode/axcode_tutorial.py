...
# 3. Try asking AXCode to "make this more readable"
...
# 3. Try asking AXCode "what sorting algorithm is this?"
...
# 2. Use the "/init" slash command to generate a AXCODE.md file
 
# ——————————————————      Learn more at https://docs.axcode.dev/getting-started/overview      ——————————————————— #
